...
import { deleteFile } from "@/api/modules/login";
...
const ATable = ({ handleSearch, params, setParams, list = [], total, loading }: Props) => {
	...
	const columns: ColumnProps<any>[] = [
		...
		{ dataIndex: "department", title: "发布部门" },
		{ dataIndex: "recipientDept", title: "收件部门" },
			...
			render: (_, record) => {
				return (
					<>
						...
						<Upload uploadUrl="/officialDocumentsDO/upload" id={record.id} showUploadList={false} refresh={handleSearch} />
						{record.filePath && (
	...
	return (
		<Card>
			<div className={styles.card_header}>
				<span className={styles.card_header_title}>文件列表</span>
